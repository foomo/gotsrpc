...
func (tsc *ServiceGoRPCClient) GetEnvelope(id string) (retGetEnvelope_0 *github_com_foomo_gotsrpc_v2_tests_generics_private.Envelope[github_com_foomo_gotsrpc_v2_tests_common.Item], clientErr error) {
...
func (tsc *ServiceGoRPCClient) SetEnvelope(env *github_com_foomo_gotsrpc_v2_tests_generics_private.Envelope[github_com_foomo_gotsrpc_v2_tests_common.Item]) (retSetEnvelope_0 string, clientErr error) {
