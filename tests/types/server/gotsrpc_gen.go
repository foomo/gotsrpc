...
func NewServiceGoTSRPCProxy(service Service, endpoint string) *ServiceGoTSRPCProxy {
	return &ServiceGoTSRPCProxy{
		...
		lastIsError: map[string]bool{
			...
			"Int64Slice":            false,
			"MapOfMaps":             false,
			"MapOfSimpleSlice":      false,
			"MixedArgs":             false,
			"MultiArgs":             false,
			"NestedStruct":          false,
			"SimplePtrSlice":        false,
			"SimpleSlice":           false,
			"SimpleStruct":          false,
			"SliceOfMaps":           false,
			"String":                false,
			"StringInt64Map":        false,
			"StringPtr":             false,
			"StringSimpleMap":       false,
			"StringSimplePtrMap":    false,
			"StringSlice":           false,
			"StringSlice2D":         false,
			"StringStringMap":       false,
			"StringStringSliceMap":  false,
			"StructWithCollections": false,
			"StructWithPointers":    false,
		},
	}
}
