...
import * as encoding_json from './vo.encoding.json'; // ./client/client.ts to ./client/vo.encoding.json.ts
...
export class ServiceClient {
	...
	async jSONRawMessage(v:encoding_json.RawMessage):Promise<encoding_json.RawMessage> {
		return (await this.transport<{0:encoding_json.RawMessage}>("JSONRawMessage", [v]))[0]
	}
	...
	async mapOfSimpleSlice(v:Record<string,Array<github_com_foomo_gotsrpc_v2_tests_common.Simple>|null>|null):Promise<Record<string,Array<github_com_foomo_gotsrpc_v2_tests_common.Simple>|null>|null> {
		return (await this.transport<{0:Record<string,Array<github_com_foomo_gotsrpc_v2_tests_common.Simple>|null>|null}>("MapOfSimpleSlice", [v]))[0]
	}
	async mixedArgs(s:github_com_foomo_gotsrpc_v2_tests_common.Simple, items:Array<string>|null, m:Record<string,number>|null):Promise<{ret:github_com_foomo_gotsrpc_v2_tests_common.Simple; ret_1:Array<string>|null; ret_2:Record<string,number>|null}> {
		const response = await this.transport<{0:github_com_foomo_gotsrpc_v2_tests_common.Simple; 1:Array<string>|null; 2:Record<string,number>|null}>("MixedArgs", [s, items, m])
	...
	async nestedStruct(v:github_com_foomo_gotsrpc_v2_tests_common.Nested):Promise<github_com_foomo_gotsrpc_v2_tests_common.Nested> {
		return (await this.transport<{0:github_com_foomo_gotsrpc_v2_tests_common.Nested}>("NestedStruct", [v]))[0]
	}
	...
	async simplePtrSlice(v:Array<github_com_foomo_gotsrpc_v2_tests_common.Simple|null>|null):Promise<Array<github_com_foomo_gotsrpc_v2_tests_common.Simple|null>|null> {
		return (await this.transport<{0:Array<github_com_foomo_gotsrpc_v2_tests_common.Simple|null>|null}>("SimplePtrSlice", [v]))[0]
	}
	async simpleSlice(v:Array<github_com_foomo_gotsrpc_v2_tests_common.Simple>|null):Promise<Array<github_com_foomo_gotsrpc_v2_tests_common.Simple>|null> {
		return (await this.transport<{0:Array<github_com_foomo_gotsrpc_v2_tests_common.Simple>|null}>("SimpleSlice", [v]))[0]
	}
	async simpleStruct(v:github_com_foomo_gotsrpc_v2_tests_common.Simple):Promise<github_com_foomo_gotsrpc_v2_tests_common.Simple> {
		return (await this.transport<{0:github_com_foomo_gotsrpc_v2_tests_common.Simple}>("SimpleStruct", [v]))[0]
	}
	...
	async stringSimpleMap(v:Record<string,github_com_foomo_gotsrpc_v2_tests_common.Simple>|null):Promise<Record<string,github_com_foomo_gotsrpc_v2_tests_common.Simple>|null> {
		return (await this.transport<{0:Record<string,github_com_foomo_gotsrpc_v2_tests_common.Simple>|null}>("StringSimpleMap", [v]))[0]
	}
	async stringSimplePtrMap(v:Record<string,github_com_foomo_gotsrpc_v2_tests_common.Simple|null>|null):Promise<Record<string,github_com_foomo_gotsrpc_v2_tests_common.Simple|null>|null> {
		return (await this.transport<{0:Record<string,github_com_foomo_gotsrpc_v2_tests_common.Simple|null>|null}>("StringSimplePtrMap", [v]))[0]
	}
