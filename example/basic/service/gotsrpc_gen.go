...
func (p *ServiceGoTSRPCProxy) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case ServiceGoTSRPCProxyBool:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Bool)
	...
	case ServiceGoTSRPCProxyBoolPtr:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.BoolPtr)
		callStats.Execution = time.Since(executionStart)
		rets = []any{boolPtrRet}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyBoolSlice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.BoolSlice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyContext:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Context)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyEmpty:
		...
		executionStart := time.Now()
		p.service.Empty()
		callStats.ResponseTypes = reflect.TypeOf(p.service.Empty)
		callStats.Execution = time.Since(executionStart)
		rets = []any{}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyFloat32:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float32)
		callStats.Execution = time.Since(executionStart)
		rets = []any{float32Ret}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyFloat32Map:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float32Map)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat32Slice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float32Slice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat32Type:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float32Type)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat32TypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float32TypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat32TypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float32TypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat64:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float64)
		callStats.Execution = time.Since(executionStart)
		rets = []any{float64Ret}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyFloat64Map:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float64Map)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat64Slice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float64Slice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat64Type:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float64Type)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat64TypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float64TypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyFloat64TypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Float64TypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int)
		callStats.Execution = time.Since(executionStart)
		rets = []any{intRet}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyInt32:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int32)
		callStats.Execution = time.Since(executionStart)
		rets = []any{int32Ret}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyInt32Map:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int32Map)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt32Slice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int32Slice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt32Type:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int32Type)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt32TypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int32TypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt32TypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int32TypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt64:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int64)
		callStats.Execution = time.Since(executionStart)
		rets = []any{int64Ret}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyInt64Map:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int64Map)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt64Slice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int64Slice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt64Type:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int64Type)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt64TypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int64TypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInt64TypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Int64TypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyIntMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.IntMap)
		callStats.Execution = time.Since(executionStart)
		rets = []any{intMapRet}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyIntSlice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.IntSlice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyIntType:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.IntType)
		callStats.Execution = time.Since(executionStart)
		rets = []any{intTypeRet}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyIntTypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.IntTypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyIntTypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.IntTypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInterface:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.Interface)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyInterfaceSlice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.InterfaceSlice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyNestedType:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.NestedType)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyString:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.String)
		callStats.Execution = time.Since(executionStart)
		rets = []any{stringRet}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyStringMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.StringMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyStringSlice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.StringSlice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyStringType:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.StringType)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyStringTypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.StringTypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyStringTypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.StringTypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt)
		callStats.Execution = time.Since(executionStart)
		rets = []any{uIntRet}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyUInt32:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt32)
		callStats.Execution = time.Since(executionStart)
		rets = []any{uInt32Ret}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyUInt32Map:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt32Map)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt32Slice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt32Slice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt32Type:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt32Type)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt32TypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt32TypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt32TypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt32TypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt64:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt64)
		callStats.Execution = time.Since(executionStart)
		rets = []any{uInt64Ret}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyUInt64Map:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt64Map)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt64Slice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt64Slice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt64Type:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt64Type)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt64TypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt64TypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUInt64TypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UInt64TypeMapTyped)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUIntMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UIntMap)
		callStats.Execution = time.Since(executionStart)
		rets = []any{uIntMapRet}
		if err := gotsrpc.Reply(rets, callStats, r, w); err != nil {
			gotsrpc.ErrorCouldNotReply(w)
	...
	case ServiceGoTSRPCProxyUIntSlice:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UIntSlice)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUIntType:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UIntType)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUIntTypeMap:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UIntTypeMap)
		callStats.Execution = time.Since(executionStart)
	...
	case ServiceGoTSRPCProxyUIntTypeMapTyped:
		...
		callStats.ResponseTypes = reflect.TypeOf(p.service.UIntTypeMapTyped)
		callStats.Execution = time.Since(executionStart)
