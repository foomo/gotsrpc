...
func NewServiceGoTSRPCProxy(service Service, endpoint string) *ServiceGoTSRPCProxy {
	return &ServiceGoTSRPCProxy{
		...
		lastIsError: map[string]bool{
			...
			"Float32Slice":        false,
			"Float32Type":         false,
			"Float32TypeMap":      false,
			"Float32TypeMapTyped": false,
			"Float64":             false,
			"Float64Map":          false,
			"Float64Slice":        false,
			"Float64Type":         false,
			"Float64TypeMap":      false,
			"Float64TypeMapTyped": false,
			"Int":                 false,
			"Int32":               false,
			"Int32Map":            false,
			"Int32Slice":          false,
			"Int32Type":           false,
			"Int32TypeMap":        false,
			"Int32TypeMapTyped":   false,
			"Int64":               false,
			"Int64Map":            false,
			"Int64Slice":          false,
			"Int64Type":           false,
			"Int64TypeMap":        false,
			"Int64TypeMapTyped":   false,
			"IntMap":              false,
			"IntSlice":            false,
			"IntType":             false,
			"IntTypeMap":          false,
			"IntTypeMapTyped":     false,
			"Interface":           false,
			...
			"UInt32Type":          false,
			"UInt32TypeMap":       false,
			"UInt32TypeMapTyped":  false,
			"UInt64":              false,
			"UInt64Map":           false,
			"UInt64Slice":         false,
			"UInt64Type":          false,
			"UInt64TypeMap":       false,
			"UInt64TypeMapTyped":  false,
			"UIntMap":             false,
			"UIntSlice":           false,
			"UIntType":            false,
			"UIntTypeMap":         false,
			"UIntTypeMapTyped":    false,
		},
	}
}
